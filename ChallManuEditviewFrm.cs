...
{
    public partial class ChallManuEditviewFrm : Form
    {
        ...
        public ChallManuEditviewFrm()
        {
            InitializeComponent();
        }

        private void ChallManuEditviewFrm_Load(object sender, EventArgs e)
        {
            bind();
        }
        ...
        private void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            try
            {
               ...
               // labinvoNo.Text= de.Rows[i][0].ToString();
                ...
                ManufacturersFrm manui = new ManufacturersFrm();
                manui.priya =priya;
                manui.Show();
